...
class AdminController extends Controller
{
    ...
    public function addEditOtherSetting(Request $request, $id = null)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            $minMaxCartVal->save();
            return redirect('admin/other-setting')->with('success', $message);
        }
        //dd($adminData);
    ...
    public function login(Request $request)
    {
        ...
        if ($request->isMethod('POST')) {
            ...
            if (Auth::guard('admin')->attempt(['email_phone' => $data['email_phone'], 'password' => $data['password']])) {
                //dd('okay');
    ...
    public function adminSubAdmins()
    {
        if (Auth::guard('admin')->user()->type == "subAdmin") {
            return redirect('admin/dashboard')->with('error', 'This feature is restricted!!');
        }
        $data['title'] = "Admin";
    ...
    public function addEditAdminSubadmin(Request $request, $id = null)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            $adminData->save();
            return redirect('admin/admin-subadmins')->with('success', $message);
        }
        //dd($adminData);
